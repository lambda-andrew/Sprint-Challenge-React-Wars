...
React is a JS library used to build intuitive and modern UIs. It is based around Components, and is Declarative. 

- [ ] What does it mean to _think_ in react?
Thinking in React means understanding how, why and where to place content, like first breaking it down into separate components.

- [ ] Describe state.
React State allows React components to change their output over time in response to user actions.

- [ ] Describe props.
React props allow us to pass data to our components.
